        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className={`${BG_CLASSES.cardGradient} p-8 rounded-2xl border border-red-500/30`}>
            ...
            <p className="text-red-400 text-sm mt-4 font-medium">
              Disponible para Android <br></br><span className='underline'><a href='https://www.mediafire.com/file/e71f3mmia9dl7m2/AppVampyr.apk/file' target='_blank'>Descarga aquí.</a></span>
            </p>
          </div>
        </div>
